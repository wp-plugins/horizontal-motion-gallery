...
function my_hmg_admin_option() 
{
	...
	Note: Check official website for live demo and more information  <a target="_blank" href='http://www.gopipulse.com/work/2010/07/18/horizontal-motion-gallery/'>click here</a><br /><br />
	<input name="Help" lang="publish" class="button-primary" onclick="window.open('http://www.gopipulse.com/work/2010/07/18/horizontal-motion-gallery/');" value="Help" type="button" />
    </p>
	<?php
	echo "</div>";
}
...
function my_hmg_control()
{
	...
	echo 'click here</a></p>';
	?>
	Check official website for live demo and more information  <a target="_blank" href='http://www.gopipulse.com/work/2010/07/18/horizontal-motion-gallery/'>click here</a><br>
	<?php
}
