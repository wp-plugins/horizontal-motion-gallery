...
function my_hmg_admin_option() 
{
    ...
    <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/11/10/horizontal-motion-gallery/'>click here</a> To post suggestion or comments or how to improve this plugin. <br> 
    <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/11/10/horizontal-motion-gallery/'>click here</a> To see LIVE demo. <br> 
    <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/11/10/horizontal-motion-gallery/'>click here</a> To download my other plugins. <br> 
    </p>
	<?php
	echo "</div>";
}
